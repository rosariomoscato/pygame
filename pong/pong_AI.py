...
#Title: Pong AI
#Features: Human Player Vs CPU and Simulation (CPU Vs CPU)
...
while run:
    ...
    draw_text('P1: ' + str(player_score), font, orange, screen_width - 100, 15)
    ...
    if live_ball == False:
        if winner == 0:
            draw_text('CLICK ANYWHERE TO START', font, orange, 100, screen_height // 2 - 100)
